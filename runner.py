...
if __name__ == "__main__":
    ...
    # bf5d967c
    # galaxy------ python3 runner.py bf5d967c 192.168.1.192 com.switchvpn.app com.cv.creator '--appium_port 8201 --proxy_port 8080 --system_port 8200'
    ...
    # tablet------ python3 runner.py 01f8ee7c 192.168.1.192 com.playmetrics com.flavionet.android.camera.lite '--appium_port 7201 --proxy_port 7080 --system_port 7200'
